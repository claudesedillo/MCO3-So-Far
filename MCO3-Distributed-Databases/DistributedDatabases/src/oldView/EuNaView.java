...
public class EuNaView extends JFrame implements ItemListener{
	
	private Node europeAmericaNode = new Node(2);
	...
	public EuNaView(String title){
		...
		mainC.gridx = 0;
		mainC.gridy = 0;
		JLabel choiceLbl = new JLabel("Node 2: Europe and North America");
		...
		locSelect1RB.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				ArrayList<String[]> dataRetrieved = europeAmericaNode.retrieveData(nodesChecked, queries);
		...
		insert1RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				europeAmericaNode.executeQueryAt(Node.EUROPE_AMERICA_NODE_NUMBER, SQLQueries.insertEuropeData1, SQLQueries.countryCodeEu1);
		...
		insert2RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				europeAmericaNode.executeQueryAt(Node.EUROPE_AMERICA_NODE_NUMBER, SQLQueries.insertEuropeData2, SQLQueries.countryCodeEu2);
		...
		update1RB.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				europeAmericaNode.executeQueryAt(Node.EUROPE_AMERICA_NODE_NUMBER, SQLQueries.updateEuropeData1, SQLQueries.countryCodeEu1);
			}
		...
		update2RB.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				europeAmericaNode.executeQueryAt(Node.EUROPE_AMERICA_NODE_NUMBER, SQLQueries.updateEuropeData2, SQLQueries.countryCodeEu2);
			}
		});
		...
		delete1RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				europeAmericaNode.executeQueryAt(Node.EUROPE_AMERICA_NODE_NUMBER, SQLQueries.deleteEuropeData1, SQLQueries.countryCodeEu1);
		...
		delete2RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				europeAmericaNode.executeQueryAt(Node.EUROPE_AMERICA_NODE_NUMBER, SQLQueries.deleteEuropeData2, SQLQueries.countryCodeEu2);
			}
		});
		...
		gloInsert1RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(node1RB.isSelected())
					europeAmericaNode.executeQueryAt(Node.BOTH_NODE_NUMBER, SQLQueries.insertAllData1, SQLQueries.countryCodeEu3);
				else
					europeAmericaNode.executeQueryAt(Node.ASIA_AFRICA_NODE_NUMBER, SQLQueries.insertAsiaAfricaData1, SQLQueries.countryCodeAsAf1);
		...
		gloInsert2RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				if(node1RB.isSelected())
					europeAmericaNode.executeQueryAt(Node.BOTH_NODE_NUMBER, SQLQueries.insertAllData2, SQLQueries.countryCodeAsAf4);
				else
					europeAmericaNode.executeQueryAt(Node.ASIA_AFRICA_NODE_NUMBER, SQLQueries.insertAsiaAfricaData2, SQLQueries.countryCodeAsAf2);
			}	
		});
		...
		gloUpdate1RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				if(node1RB.isSelected())
					europeAmericaNode.executeQueryAt(Node.BOTH_NODE_NUMBER, SQLQueries.updateAllData1, SQLQueries.countryCodeEu4);
				else
					europeAmericaNode.executeQueryAt(Node.ASIA_AFRICA_NODE_NUMBER, SQLQueries.updateAsiaData1, SQLQueries.countryCodeAsAf1);
			}
		});
		...
		gloUpdate2RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				if(node1RB.isSelected())
					europeAmericaNode.executeQueryAt(Node.BOTH_NODE_NUMBER, SQLQueries.updateAllData2, SQLQueries.countryCodeEu5);
				else
					europeAmericaNode.executeQueryAt(Node.ASIA_AFRICA_NODE_NUMBER, SQLQueries.updateAsiaData2, SQLQueries.countryCodeAsAf2);
		...
		gloDelete1RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				if(node1RB.isSelected())
					europeAmericaNode.executeQueryAt(Node.BOTH_NODE_NUMBER, SQLQueries.deleteAllData1, SQLQueries.countryCodeEu3);
				else
					europeAmericaNode.executeQueryAt(Node.ASIA_AFRICA_NODE_NUMBER, SQLQueries.deleteAsiaData1, SQLQueries.countryCodeAsAf1);
		...
		gloDelete2RB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				if(node1RB.isSelected())
					europeAmericaNode.executeQueryAt(Node.BOTH_NODE_NUMBER, SQLQueries.deleteAllData2, SQLQueries.countryCodeEu4);
				else
					europeAmericaNode.executeQueryAt(Node.ASIA_AFRICA_NODE_NUMBER, SQLQueries.deleteAsiaData2, SQLQueries.countryCodeAsAf2);
