...
public class EuropeView extends JFrame{
	...
	private JRadioButton allRB, asiaRB;
	
	public EuropeView() {
		super("Node 2: Europe and America");
		...
		globalUpdate1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(allRB.isSelected())
					node.executeQueryAt(Node.BOTH_NODE_NUMBER, SQLQueries.updateAllData1, SQLQueries.countryCodeEu4);
				else
		...
		asiaRB.setBounds(738, 147, 192, 23);
